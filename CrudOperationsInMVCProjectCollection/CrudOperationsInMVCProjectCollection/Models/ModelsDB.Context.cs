...
namespace CrudOperationsInMVCProjectCollection.Models
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual DbSet<customersbackup> customersbackups { get; set; }
        public virtual DbSet<Alphabetical_list_of_product> Alphabetical_list_of_products { get; set; }
        public virtual DbSet<brazil_customers_> brazil_customers_ { get; set; }
        ...
        public virtual DbSet<view_CustomerProducts> view_CustomerProducts { get; set; }
    
        [DbFunction("NORTHWNDEntities", "fn_GetCustomersByCity")]
        public virtual IQueryable<fn_GetCustomersByCity_Result> fn_GetCustomersByCity()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetCustomersByCity_Result>("[NORTHWNDEntities].[fn_GetCustomersByCity]()");
        }
    
        [DbFunction("NORTHWNDEntities", "fn_GetCustomersByCountry")]
        public virtual IQueryable<fn_GetCustomersByCountry_Result> fn_GetCustomersByCountry(string country)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetCustomersByCountry_Result>("[NORTHWNDEntities].[fn_GetCustomersByCountry](@Country)", countryParameter);
        }
    
        [DbFunction("NORTHWNDEntities", "GetSuppliersByCity")]
        public virtual IQueryable<GetSuppliersByCity_Result> GetSuppliersByCity(string city)
        {
            var cityParameter = city != null ?
                new ObjectParameter("City", city) :
                new ObjectParameter("City", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetSuppliersByCity_Result>("[NORTHWNDEntities].[GetSuppliersByCity](@City)", cityParameter);
        }
    
        [DbFunction("NORTHWNDEntities", "GetSuppliersByCountry")]
        public virtual IQueryable<GetSuppliersByCountry_Result> GetSuppliersByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetSuppliersByCountry_Result>("[NORTHWNDEntities].[GetSuppliersByCountry](@Country)", countryParameter);
        }
        ...
        public virtual ObjectResult<spCustomersContact_Result> spCustomersContact()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spCustomersContact_Result>("spCustomersContact");
        }
    
        public virtual int spGetCompanyName(string custid, string companyName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetCompanyName", custidParameter, companyNameParameter);
        }
    
        public virtual int spGetCountOfCustomers1(ObjectParameter totalCount1)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetCountOfCustomers1", totalCount1);
        }
    
        public virtual int spGetCountOfCustomers2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetCountOfCustomers2");
        }
    
        public virtual ObjectResult<spGetCustomerContacts_Result> spGetCustomerContacts()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetCustomerContacts_Result>("spGetCustomerContacts");
        }
    
        public virtual int spGetCustomersByCountry(string country, ObjectParameter countryCount)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetCustomersByCountry", countryParameter, countryCount);
        }
    
        public virtual ObjectResult<spGetCustomersFromMadrid_Result> spGetCustomersFromMadrid(string country, string city)
        {
            var countryParameter = country != null ?
                new ObjectParameter("Country", country) :
                new ObjectParameter("Country", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetCustomersFromMadrid_Result>("spGetCustomersFromMadrid", countryParameter, cityParameter);
        }
        ...
        public virtual ObjectResult<spProductsByQuantity_Result> spProductsByQuantity(string quantityperunit, Nullable<decimal> unitprice)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spProductsByQuantity_Result>("spProductsByQuantity", quantityperunitParameter, unitpriceParameter);
        }
