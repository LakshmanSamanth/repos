...
namespace WindowsFormsSqlConn {
    ...
    public partial class MyDataDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/MyDataDataSet1.xsd";
        ...
        public partial class EmpDataTable : global::System.Data.TypedTableBase<EmpRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmpRow AddEmpRow(string Name, int Salary) {
...
namespace WindowsFormsSqlConn.MyDataDataSetTableAdapters {
    ...
    public partial class EmpTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Emp] WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [" +
                "Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Salary = 1 AND [Salar" +
                "y] IS NULL) OR ([Salary] = @Original_Salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Emp] ([Name], [Salary]) VALUES (@Name, @Salary);\r\nSELECT ID, N" +
                "ame, Salary FROM Emp WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Emp] SET [Name] = @Name, [Salary] = @Salary WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)));
SELECT ID, Name, Salary FROM Emp WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsSqlConn.Properties.Settings.Default.MyDataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Salary FROM dbo.Emp";
        ...
        public virtual int Fill(MyDataDataSet.EmpDataTable dataTable) {
        ...
        public virtual MyDataDataSet.EmpDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDataDataSet.EmpDataTable dataTable = new MyDataDataSet.EmpDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDataDataSet.EmpDataTable dataTable) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Salary, int Original_ID, string Original_Name, global::System.Nullable<int> Original_Salary, int ID) {
            if ((Name == null)) {
